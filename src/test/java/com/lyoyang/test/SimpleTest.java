...
public class SimpleTest {
    ...
    private static final String PRIVATE_KEY = "E:\\nowpay\\wechat_batch\\1579283521_20200407_cert\\apiclient_cert.p12";
...
//        }
    ...
    public void getSequence() throws Exception {
        ...
        FileInputStream fileInputStream = new FileInputStream(new File(PRIVATE_KEY));
        keyStore.load(fileInputStream, "1579283521".toCharArray());
        Certificate tenpay_certificate = keyStore.getCertificate(keyStore.aliases().nextElement());
        SerialNumber serialNumber = (SerialNumber) ((X509CertImpl) tenpay_certificate).get(X509CertImpl.SERIAL_ID);
