...
public class DateUtil extends Object {
     ...
     * 年月日时分秒无分隔符*
     */
    public final static String FORMAT_TRADETIME_HOUR = "yyyyMMddHHmm";
    ...
    /**
     * 校验  日期格式的字符串参数
     * （作为service参数来讲,格式一般为 yyyy-MM-dd 或类似格式，不考虑 utc时间）
     * <p/>
     * 1. 判断格式是否非法, 如： 2017-111111111-02
     * <p/>
     * 2. 判断日期是否合乎逻辑 如: 2016-7-33
     *
     * @param
     * @return
     */
    public static boolean isRightDate(String timeStr) {
...
//       System.out.print(isRightDate("2016-8-30"));

        getDateFromString("2016-07-17", "yyyy-MM-dd");
    ...
    * 获取当前日期的前一天
    * */
    public static Date getPreDateTime(Date nowTime) {
        Calendar calendar = Calendar.getInstance();
